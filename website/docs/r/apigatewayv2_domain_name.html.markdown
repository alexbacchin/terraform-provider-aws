...
* `routing_mode` - (Optional) - The routing mode API Gateway uses to route traffic to your APIs. Valid values: `API_MAPPING_ONLY`,`ROUTING_RULE_ONLY`,`ROUTING_RULE_THEN_API_MAPPING`. Defaults to `API_MAPPING_ONLY`
